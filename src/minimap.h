...
//typedef struct { size_t n, m; mm128_t *a; } mm64_v;
// minimap2 index
typedef struct {
...
mm_idx_t *mm_idx_build(const char *fn, int w, int blend_bits, int k, int k_shift, int flag, int isMinimzer, int n_threads);
